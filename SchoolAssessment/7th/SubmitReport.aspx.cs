 ...
 * 
 * 07/16/2019 AT Commented out TxtOthersTotal.  No longer needs to calculate the sum of otehr (IEP Services, Independent Study, Home-based Private School)
 */
...
namespace SchoolAssessment._7th
{
    public partial class SubmitReport : System.Web.UI.Page
    {
        ...
        */
        ...
        {
            if ((Convert.ToInt32(txtPermMedExmp.Text)  + Convert.ToInt32(TextIEPServices.Text) + Convert.ToInt32(TextIndependentStudy.Text) + Convert.ToInt32(TextHomeBasedPrivate.Text)  + Convert.ToInt32(TextMedExmption.Text) + Convert.ToInt32(TextEnrolledButNotAttending.Text)) > (Convert.ToInt32(txtPolio.Text) + Convert.ToInt32(txtDtp.Text) + Convert.ToInt32(txtMMR2.Text) + Convert.ToInt32(txtHepb.Text) + Convert.ToInt32(txtVZV.Text)))
            {
                args.IsValid = false;
            }
            else {
    ...
    */
                        ...
                        //Response.Redirect("ViewAndPrint.aspx", true);
                        Response.Redirect("SubmitEigthGradeReport.aspx", true);
                    }
                    else {
