<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginForgotSchCode.aspx.cs" Inherits="SchoolAssessment._7th.LoginForgotSchCode" %>
        ...
        <div id="header-wrap">
            <div id="header">
                <div id="logo">
                    ...
                    <a href="https://www.shotsforschool.org/reporting/" target="_blank"><img src="Images/hdr_7th_2.jpg" alt="7th Grade Immunization Assessment" /></a>
                </div>

                <div id="topbnr">

                    <a href="https://www.shotsforschool.org/reporting/7th/" target="_blank" alt="Instruction" title="Reporting Instruction">Instructions
                        <img src="Images/Icon_instr.png" width="15" />
                    </a>| 
               <a href="https://www.shotsforschool.org/reporting/kindergarten/faqs/" target="_blank" alt="FAQs" title="FAQs">FAQs
                   <img src="Images/Icon_instr.png" width="15" />
               </a><!--| 
               Worksheet<a href="http://cairweb.org/calkidshots/PM236a.xls" target="_blank">
                   <img src="Images/Icon_Excel.png" width="15" height="15" alt="Xls" title="Xls Worksheet" />
               </a>&nbsp; <a href="http://cairweb.org/calkidshots/PM236a.pdf" target="_blank">
                   <img src="Images/Icon_adobe.png" width="15" height="15" alt="PDF" title="PDF Worksheet" /></a>-->

                </div>

            </div>
            <div id="duedateLogin">Reporting is due January 31, 2022</div>
        </div>
        <div id="content-wrap">
            <div id="content">
                ...
                -->
                <p>
                    <!--<span class="redbold">Electronic reporting has closed for this school year. Schools that have not yet reported should contact their <a href="https://www.cdph.ca.gov/Programs/CID/DCDC/Pages/Immunization/Local-Health-Department.aspx" target="_blank">local health department</a> or email <a href="mailto:SchoolAssessments@cdph.ca.gov">SchoolAssessments@cdph.ca.gov</a></span>-->
                    Electronic reporting has closed for this school year. If you submitted your report before the deadline, you may log in to your account to access a printable PDF summary of your results. Reporting for the 2019-2020 school year will open in September.
                </p>			
                    ...
                    <tr>
                        ...
                        <td width="350px" valign="center">
                            <table width="350px" cellspacing="2">
                                ...
                                <tr><td><br /></td></tr>
                                <tr><td class="indent2"><a href="LoginForgotSchCode.aspx"><img src="Images/Icon_triangle.png" /> Search For Your School</a>
                                    </td></tr>
