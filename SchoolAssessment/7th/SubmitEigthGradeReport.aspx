<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubmitEigthGradeReport.aspx.cs" Inherits="SchoolAssessment._7th.SubmitEithGradeReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>California 8th Grade Immunization Assessment</title>
...
<body>
    ...
    <div id="content-wrap">
      <div id="content" >
        <br />
        <center><img src="Images/step_7_4.png" alt="School information:" /></center>
        <h2><img src="Images/hdr-submit8th.jpg" alt="Please confirm School information:" /></h2>
        ...
        <table width="825">
            ...
            <tr>
                <td colspan="7"><b>Status:</b> <asp:Label ID="lblStatus" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td colspan="7">
                    <br />
            ...
            <tr>
                ...
                <td width="80">
                    <asp:textbox id="txttotno" tabindex="1" columns="4" runat="server" maxlength="4" Width="50px" onkeyup="calculateTextTotal();"></asp:textbox>
                          <asp:requiredfieldvalidator id="RequiredFieldValidator30" controltovalidate="txttotno" text="&bull;" errormessage="Number of 8th grade students enrolled this year - Required" runat="server" cssclass="RequiredFieldValidator" display="Dynamic" />
                          <asp:rangevalidator id="Rangevalidator25" controltovalidate="txttotno" minimumvalue="0" maximumvalue="9999" type="Integer" cssclass="RequiredFieldValidator" text="&bull;" errormessage="Number of 8th grade students enrolled this year - Numbers only" runat="server" display="Dynamic" />
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" controltovalidate="V_txtAllimm" text="&bull;" errormessage="Number of 8th graders with Varicella doses - Required" runat="server" cssclass="RequiredFieldValidator" display="Dynamic" ></asp:RequiredFieldValidator>
                   </td>
                <td></td>
                <td><small>A</small></td>
                <td><asp:textbox id="txtAllimm" tabindex="11" columns="4" runat="server" maxlength="4" Width="50px"  onkeyup="calculateTextTotal();"></asp:textbox>
                          <asp:requiredfieldvalidator id="RequiredFieldValidator1" controltovalidate="txtAllimm" text="&bull;" errormessage="Number of 8th graders with Tdap doses - Required" runat="server" cssclass="RequiredFieldValidator" display="Dynamic" />
                          <asp:rangevalidator id="Rangevalidator1" controltovalidate="txtAllimm" minimumvalue="0" maximumvalue="9999" type="Integer" cssclass="RequiredFieldValidator" text="&bull;" errormessage="Number of 8th graders with all required immunizations and/or documented history of disease - Numbers only" runat="server" display="Dynamic" />
                </td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="V_txtPermMedExmp" Text="&bull;" ErrorMessage="Number of 8th graders with Permanent Medical Exemptions to any immunizations - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic" ></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator2" ControlToValidate="V_txtPermMedExmp"  MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders with Permanent Medical Exemptions to any immunizations - Numbers only" runat="server" Display="Dynamic" ></asp:RangeValidator>
                </td>
                <td></td>
                <td><small>C1</small></td>
                <td><asp:TextBox ID="txtPermMedExmp" TabIndex="12" Columns="4" runat="server" MaxLength="4" Width="50px"  onkeyup="calculateTextTotal();"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ControlToValidate="txtPermMedExmp" Text="&bull;" ErrorMessage="Number of 8th graders with Permanent Medical Exemptions to any immunizations - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic" />
                    <asp:RangeValidator ID="Rangevalidator7" ControlToValidate="txtPermMedExmp" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders with Permanent Medical Exemptions to any immunizations - Numbers only" runat="server" Display="Dynamic" />
                </td>
			...
			<tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="V_MDMO_PermMedExmp" Text="&bull;" ErrorMessage="Number of 8th graders with Permanent Medical Exemption - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator4" ControlToValidate="V_MDMO_PermMedExmp" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders with Permanent Medical Exemptions to any immunizations - Numbers only" runat="server" Display="Dynamic"></asp:RangeValidator>                
                </td>
                <td></td>
                <td>&nbsp;</td>
                <td></td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ControlToValidate="V_TextIEPServices" Text="&bull;" ErrorMessage="Number of 8th graders with IEP Service Exemptions - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator5" ControlToValidate="V_TextIEPServices" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders with IEP Service Exemptions - Numbers only" runat="server" Display="Dynamic"></asp:RangeValidator>                
                </td>
                <td></td>
                <td><small>F1</small></td>
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" ControlToValidate="TextIEPServices" Text="&bull;" ErrorMessage="Number of 8th graders who have a ‘IEP Services’ Exemption - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic" />
                    <asp:RangeValidator ID="Rangevalidator12" ControlToValidate="TextIEPServices" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders who have a ‘‘IEP Services’ Exemption - Numbers only" runat="server" Display="Dynamic" />
                </td>
                <td></td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="V_TextIndependentStudy" Text="&bull;" ErrorMessage="Number of 8th graders with Independent Study Exemption - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator6" ControlToValidate="V_TextIndependentStudy" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders with Independent StudyExemptions to any immunizations - Numbers only" runat="server" Display="Dynamic"></asp:RangeValidator>
                    </td>
                <td></td>
                <td><small>F2</small></td>
                <td><asp:TextBox ID="TextIndependentStudy" TabIndex="14" runat="server" MaxLength="4" Columns="4"  Width="50px" onkeyup="calculateTextTotal();"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" ControlToValidate="TextIndependentStudy" Text="&bull;" ErrorMessage="Number of 8th graders who have a ‘Independent Study’ Exemption - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic" />
                    <asp:RangeValidator ID="Rangevalidator13" ControlToValidate="TextIndependentStudy" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders who have a ‘Independent Study’ Exemption - Numbers only" runat="server" Display="Dynamic" /> 
                </td>
                <td></td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="V_TextHomeBasedPrivate" Text="&bull;" ErrorMessage="Number of 8th graders with Permanent Medical Exemption - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator8" ControlToValidate="V_TextHomeBasedPrivate" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders with Permanent Medical Exemptions to any immunizations - Numbers only" runat="server" Display="Dynamic"></asp:RangeValidator>
                    </td>
                <td></td>
                <td><small>F3</small></td>
                <td><asp:TextBox ID="TextHomeBasedPrivate" TabIndex="15" runat="server" MaxLength="4" Columns="4"  Width="50px" onkeyup="calculateTextTotal();"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" ControlToValidate="TextHomeBasedPrivate" Text="&bull;" ErrorMessage="Number of 8th graders who have a ‘Home-based Private School’ Exemption - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic" />
                    <asp:RangeValidator ID="Rangevalidator14" ControlToValidate="TextHomeBasedPrivate" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders who have a ‘Home-based Private School’ Exemption - Numbers only" runat="server" Display="Dynamic" />
                </td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ControlToValidate="V_ConditionalNotDue" Text="&bull;" ErrorMessage="Number of 8th graders with Conditional-Missing Doses Not Currently Due - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator9" ControlToValidate="V_ConditionalNotDue" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders with Conditional-Missing Doses Not Currently Due - Numbers only" runat="server" Display="Dynamic"></asp:RangeValidator>
                </td>
                <td></td>
                <td>&nbsp;</td>
                <td></td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" ControlToValidate="V_TextMedExmption" Text="&bull;" ErrorMessage="Number of 8th graders with Temporary Medical Exemption - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator15" ControlToValidate="V_TextMedExmption" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders with Temporary Medical Exemption - Numbers only" runat="server" Display="Dynamic"></asp:RangeValidator>
                </td>
                <td></td>
                <td><small>D</small></td>
                <td><asp:TextBox ID="TextMedExmption" TabIndex="16" runat="server" Columns="4" MaxLength="4" Width="50px"  onkeyup="calculateTextTotal();"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" ControlToValidate="TextMedExmption" Text="&bull;" ErrorMessage="Number of 8th graders who do not meet all the immunization requirements - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic" />
                    <asp:RangeValidator ID="Rangevalidator11" ControlToValidate="TextMedExmption" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders who do not meet all the immunization requirements - Numbers only" runat="server" Display="Dynamic" />
                </td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td >
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" ControlToValidate="V_TextEnrolledButNotAttending" Text="&bull;" ErrorMessage="Number of 8th graders with Overdue-Needs Doses Now - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator10" ControlToValidate="V_TextEnrolledButNotAttending" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders with Overdue-Needs Doses Now - Numbers only" runat="server" Display="Dynamic"></asp:RangeValidator>
                    </td>
                <td ></td>
                <td ><small>G</small></td>
                <td><asp:TextBox ID="TextEnrolledButNotAttending" TabIndex="17" Columns="4" runat="server" MaxLength="4" Width="50px"  onkeyup="calculateTextTotal();"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="TextEnrolledButNotAttending" Text="&bull;" ErrorMessage="Number of 8th graders who do not meet all the immunization requirements - Required" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic" />
                    <asp:RangeValidator ID="Rangevalidator3" ControlToValidate="TextEnrolledButNotAttending" MinimumValue="0" MaximumValue="9999" Type="Integer" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Number of 8th graders who do not meet all the immunization requirements - Numbers only" runat="server" Display="Dynamic" />
                </td>
                <td></td>
            </tr>
            <tr>
        ...
        <p>
            ...
            <asp:ImageButton ID="ImgBtnSubmit" runat="server" Enabled="true" ImageUrl="images/btn7_submitreport.png" tabindex="19" OnClick="ImgBtnSubmit_Click"  />
        </p> 
        <p>&nbsp;</p>
        <hr />
            <br />
