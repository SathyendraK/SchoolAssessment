        ...
        */
        ...
        private void FillSchool()
        {
            ...
            try
            {
                ...
                //else {
                    //sql = "SELECT distinct [SchName] FROM K_Assessment where SchoolYear = '" + schoolyear + "' and CoName = '" + county + "' and SchType = '" + type + "' ORDER BY [SchName] asc";
                    // commented out on 10/17/2016
                    //sql = "SELECT DISTINCT [SchName] FROM Schools S INNER JOIN[Counties] C ON C.CoCode = S.Cocode INNER JOIN Assessments A on A.schCode = S.SchCode WHERE Cohort = 'C' and CoName = '" + county + "'  AND A.schoolYear = '" + SchoolYear + "' and S.EditDate > '" + ActiveSchool + "' ORDER BY[SchName] ASC";
        ...
        private void FillAddress()
        {
            ...
            try
            {
                ...
                //else {
                    ...
                    //sql = "SELECT distinct PhysStreet, PhysCity, SchCode, ENTERDATE FROM SCHOOLS S INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and C.CoName ='" + county + "' and SchName = '" + schoolname + "' ORDER BY ENTERDATE DESC, PhysStreet";
