<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginForgotSchCode.aspx.cs" Inherits="SchoolAssessment.CC.LoginForgotSchCode" %>
        ...
        <div id="header-wrap">
            <div id="header">
                <div id="logo">
                    ...
                    <a href="http://www.shotsforschool.org/reporting/" target="_blank"><img src="Images/ccheader.png" alt="Kindergarten Immunization Assessment" /></a>
                </div>
            ...
            <div id="duedateLogin">2016-2017 Reporting is Closed</div>
        </div>
        <div id="content-wrap">
            <div id="content">
                    ...
                    <tr>
                        ...
                        <td width="350px" valign="center">
                            <table width="350px" cellspacing="2">
                                ...
                                <tr><td><br /></td></tr>
                                <tr><td class="indent2"><a href="LoginForgotSchCode.aspx"><img src="Images/Icon_triangle.png" /> Search For Your Facility</a>
                                    </td></tr>
