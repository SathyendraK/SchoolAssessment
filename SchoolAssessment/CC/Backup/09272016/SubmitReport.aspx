        ...
        <div id="header-wrap">
            <div id="header">
                <div id="logo">
                    ...
                    <a href="http://www.shotsforschool.org/reporting/" target="_blank">
                        <img src="Images/ccheader.png" alt="Kindergarten Immunization Assessment" /></a>
                </div>
            ...
            <div id="help"><a href="http://shotsforschool.org/reportingtools.html">Help</a></div>-->
                ...
                <div id="topbnr">
                    <form id="Form1" method="post" runat="server">
                        <a href="http://www.cairweb.org/calkidshots/CCOnlineInstructions.pdf" target="_blank" alt="Instruction" title="Reporting Instruction">Instructions 
                            <img src="Images/Icon_instr.png" width="15" />
                        </a>| 
               <a href="http://cairweb.org/calkidshots/CCFAQs.pdf" target="_blank" alt="FAQs" title="FAQs">FAQs
                   <img src="Images/Icon_instr.png" width="15" />
               </a>| 
               Worksheet<a href="http://www.cairweb.org/calkidshots/cdph8342.xls" target="_blank">
                   <img src="Images/Icon_Excel.png" width="15" height="15" alt="Xls" title="Xls Worksheet" />
               </a>&nbsp; <a href="http://www.cairweb.org/calkidshots/cdph8342.pdf" target="_blank">
                   <img src="Images/Icon_adobe.png" width="15" height="15" alt="PDF" title="PDF Worksheet" /></a> | 
        ...
        <div id="content-wrap">
            <div id="content">
                ...
                <table width="825">
                    ...
                    <tr>
                        <td width="260"><b>Total Number of Children:</b></td>
                        <td width="10"></td>
                        <td width="80">
                    ...
                    <tr>
                        <td class="indent">
                            <img src="./images/icon_Info.png" width="14" height="14" alt="" align="center" title='Is 24 months and older and has all immunizations required for their age'>
                            All required immunizations</td>
                        <td><small>A</small></td>
                        <td>
                    ...
                    <tr>
                        <td colspan="3">
                            <img src="Images/Title_CondAdm.png" width="331" height="15" /></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td class="indent">
                            <img src="./images/icon_Info.png" width="14" height="14" alt="" align="center" title='Is missing a dose(s) in a series, but the next dose is not due yet. This means the child has received at least one dose in a series and the deadline for the next dose has not passed.  &#13; &#13; Homeless, transfer and foster students counted here if still in the process of meeting requirements/ waiting for records'>
                            Conditional Entrant</td>
                        <td><small>B</small></td>
                        <td>
                    ...
                    <tr>
                        <td class="indent" style="height: 32px">
                    ...
                    <tr>
                        <td colspan="3" class="indentInfoImg"><small>Previously Known as Enrolled But Not Attending</small></td>
                        <td></td>
                    </tr>
                    <tr>
                ...
                <p><small>By submitting this form and the the electronic signature attached hereto, I declare under penalty of perjury and the laws of the State of California that I am an authorized contact of the school and the information contained herein is true, accurate, and complete.</small></p>
                <p>
                ...
                <hr />
                <br />
                For questions about assessment, contact your <a href="http://www.cdph.ca.gov/programs/immunize/Pages/CaliforniaLocalHealthDepartments.aspx">local health department</a> or  email <a href="mailto:SchoolAssessments@cdph.ca.gov?subject=Kindergarten%20Reporting%20Help"><em>SchoolAssessments@cdph.ca.gov</em></a><p>
                    <a href="http://www.shotsforschool.org">
