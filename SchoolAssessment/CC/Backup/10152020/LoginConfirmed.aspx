    ...
    <div id="header-wrap">
      <div id="header"> <div id="logo">
          ...
          <div id="topbnr">
               ...
               Worksheet<a href="http://www.cairweb.org/calkidshots/cdph8342.xls"target="_blank"> <img src="Images/Icon_Excel.png" width="15" height="15" alt="Xls" title="Xls Worksheet"/> </a>&nbsp; <a href="http://www.cairweb.org/calkidshots/cdph8342.pdf" target="_blank"> <img src="Images/Icon_pdf.png" width="15" height="15" alt="PDF" title="PDF Worksheet" /></a> | 
               <asp:LinkButton ID="hdrLogout" runat="server" OnClick="hdrLogout_Click" CausesValidation="false">Logout</asp:LinkButton>
          </div>
              
      </div>
      <div id="duedate">Reporting is due January 29, 2021</div>
    </div>
    <div id="content-wrap">
      <div id="content">
        ...
        <table id="Table1" cellpadding="4">
          <tr><td colspan="3">Disclaimer: Information updated on this page is for reporting purposes only. All updates to facility information must be routed through <a href="https://www.cdss.ca.gov/inforesources/child-care-licensing" target="_blank">Department of Social Services- Child Care Licensing Department</a> and will be reflected next year.<br />
              <br />
              </td></tr>
            <tr>
            ...
            <tr>
                <td class="auto-style4"><b>Facility Email:</b></td>
                <td class="auto-style1"></td> 
            </tr>
           <tr><td colspan="2"><asp:TextBox ID="txtSchEmail" size="100" runat="server"></asp:TextBox>
               <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" controltovalidate="txtSchEmail" text="&bull;" errormessage="Facility Email Required" cssclass="RequiredFieldValidator"></asp:RequiredFieldValidator>
               </td></tr>
          <tr>
            <td class="auto-style4">
...
the following page to complete your submission!</asp:Label>-->
          ...
          <tr>
            ...
            <td colspan="2">
              ...
              <br /><asp:RequiredFieldValidator ID="valReason" ControlToValidate="drpReason" Text="Please select a reason" ErrorMessage="Please select a reason for not having any Childcare students enrolled this year" runat="server" CssClass="RequiredFieldValidator" Display="Dynamic" />
            </td>
          </tr>
