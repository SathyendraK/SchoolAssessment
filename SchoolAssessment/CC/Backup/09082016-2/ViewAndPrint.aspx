...
<body>
      ...
      <div id="header"> <div id="logo">
        ...
        <!--Commented out by A.T. on 09/18/2014  
         ...
         <div id="topbnr">
               ...
               <a href="http://www.cairweb.org/calkidshots/CCOnlineInstructions.pdf" target="_blank" alt="Instruction" title="Reporting Instruction">Instructions  <img src="Images/Icon_instr.png" width="15" /> </a> | 
               <a href="http://cairweb.org/calkidshots/CCFAQs.pdf" target="_blank" alt="FAQs" title="FAQs"> FAQs <img src="Images/Icon_instr.png" width="15" /> </a> | 
               Worksheet<a href="http://cairweb.org/calkidshots/PM236a.xls"target="_blank"> <img src="Images/Icon_Excel.png" width="15" height="15" alt="Xls" title="Xls Worksheet"/> </a>&nbsp; <a href="http://www.cairweb.org/calkidshots/PM236a.pdf" target="_blank"> <img src="Images/Icon_adobe.png" width="15" height="15" alt="PDF" title="PDF Worksheet" /></a> | 
    ...
    <div id="content-wrap">
      <div id="content" >
        ...
        <img src="Images/thankyou.png" width="760px" height="115px"/><br /><br />
          <p>
            <!--<asp:button id="btndownload" runat="server" Text="Download Report (PDF)" causesvalidation="False"></asp:button>-->
              ...
              <asp:ImageButton ID="ImgBtnPrintRPT"  causesvalidation="False" Enabled="true" ImageUrl="images/btn3_printreport.png"  runat="server" />
          </p>
        <table width="760">
          <tr>
                ...
                <tr>
                  <td>
                    <table width="100%">
                      ...
                      <tr>
                        <td class="auto-style5" ><strong>School Name:</strong></td>
        ...
        <table width="825">
            ...
            <tr>
                <td  class="indent"><img src="./images/icon_Info.png" width="14" height="14" alt="" align="center" title='Is 24 months and older and has all immunizations required for their age'> All required immunizations</td>
                <td><small>A</small></td>
 ...
 <tr>
            ...
            <tr>
                <td class="indent"><img src="./images/icon_Info.png" width="14" height="14" alt="" align="center" title='Submits a personal beliefs exemption (PBE) filed at a prior California child-care facility for missing shots(s) and immunization records with dates for all required shots not exempted. The PBE must have been filed before January 1, 2016 and is only valid until entry to transitional kindergarten/ kindergarten. '> Permanent Medical Exemption</td>
                <td><small>C</small></td>
            ...
            <tr>
                <td class="indent" style="height: 32px"><img src="./images/icon_Info.png" width="14" height="14" alt="" align="center" title='Enrolled but not attending, does not fit one of the previous categories and is subject to exclusion.'> Overdue Doses</td>
                <td ><small>G</small></td>
                <td >
