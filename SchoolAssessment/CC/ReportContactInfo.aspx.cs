    ...
    public partial class ReportContactInfo : System.Web.UI.Page
    {
        ...
        protected void CustomValidator1_ServerValidate(object source, System.Web.UI.WebControls.ServerValidateEventArgs args)
        {
            if (txtmail.Text.Length == 0)
            {
                ...
                args.IsValid = false;
                CustomValidator1.ErrorMessage = "facility Staff Member Completing This Form Email - Required.";
            ...
            //else if (RegexUtilities.IsValidEmail(txtmail.Text))
            {
                ...
                args.IsValid = false;
                CustomValidator1.ErrorMessage = "facility Staff Member Completing This Form Email - Invalid format.";
            }
            else
            {
                args.IsValid = true;
        ...
        protected void CustomValidator2_ServerValidate(object source, System.Web.UI.WebControls.ServerValidateEventArgs args)
        {
            ...
            {
                args.IsValid = false;
                CustomValidator2.ErrorMessage = "Designated facility Contact Email - Required.";
            }
            else if (Regex.IsMatch(txtfcemail.Text, @"\s+"))
            {
                args.IsValid = false;
                CustomValidator2.ErrorMessage = "Please remove space from Designated facility Contact Email.";
            }
            else if (!IsEmailValid(txtfcemail.Text.ToString()))
            {
                args.IsValid = false;
                CustomValidator2.ErrorMessage = "Designated facility Contact Email - Invalid format.";
            }
            else
            {
                args.IsValid = true;
        ...
        protected void CustomValidator3_ServerValidate(object source, System.Web.UI.WebControls.ServerValidateEventArgs args)
        {
            if (txtconfirmmail.Text.Length == 0)
            {
                ...
                args.IsValid = false;
                CustomValidator3.ErrorMessage = "facility Staff Member Completing This Form Confirm Email - Required.";
            ...
            else if (!IsEmailValid(txtconfirmmail.Text.ToString()))
            {
                ...
                args.IsValid = false;
                CustomValidator3.ErrorMessage = "facility Staff Member Completing This Form Confirm Email - Invalid format.";
            }
            else if (txtconfirmmail.Text != txtmail.Text)
            {

                args.IsValid = false;
                CustomValidator3.ErrorMessage = "facility Staff Member Completing This Form Confirm Email - Does not match email";
            }
            else
            {
                args.IsValid = true;
        ...
        protected void CustomValidator4_ServerValidate(object source, System.Web.UI.WebControls.ServerValidateEventArgs args)
        {
            ...
            {
                args.IsValid = false;
                CustomValidator4.ErrorMessage = "Designated facility Contact Confirm Email - Required.";
            }
            else if (Regex.IsMatch(txtfccemail.Text, @"\s+"))
            {
                args.IsValid = false;
                CustomValidator4.ErrorMessage = "Please remove space from Designated facility Contact Confirm Email.";
            }
            else if (!IsEmailValid(txtfccemail.Text.ToString()))
            {
                args.IsValid = false;
                CustomValidator4.ErrorMessage = "Designated facility Contact Confirm Email - Invalid format.";
            }
            else if (txtfccemail.Text != txtfcemail.Text)
            {

                args.IsValid = false;
                CustomValidator4.ErrorMessage = "Designated facility Contact Confirm Email - Does not match email";
            }
            else
            {
                args.IsValid = true;
        ...
        protected void CustomValidator5_ServerValidate(object source, System.Web.UI.WebControls.ServerValidateEventArgs args)
        {
            ...
            {
                args.IsValid = false;
                CustomValidator5.ErrorMessage = "Facility Staff Member Completing This Form Name - Required";
            }
            else if (!regexItem.IsMatch(txtStaffPrsn.Text))
            {
                args.IsValid = false;
                CustomValidator5.ErrorMessage = "Facility Staff Member Completing This Form Name - Invalid characters (only letters, spaces, periods, and dashes allowed)";
            }
            else
            {
                args.IsValid = true;
        ...
        protected void CustomValidator6_ServerValidate(object source, System.Web.UI.WebControls.ServerValidateEventArgs args)
        {
            ...
            {
                args.IsValid = false;
                CustomValidator6.ErrorMessage = "Designated facility Contact Name - Required";
            }
            else if (!regexItem.IsMatch(txtfcperson.Text))
            {
                args.IsValid = false;
                CustomValidator6.ErrorMessage = "Designated facility Contact Name - Invalid characters (only letters, spaces, periods, and dashes allowed)";
            }
            else
            {
                args.IsValid = true;
