                  ...
                  <td>
                      ...
                      <table cellspacing="0" width="100%">
                          <tr>
                              <td>
                                  <p class="MsoNormal">
                                      Disclaimer: Information updated on this page is for reporting purposes only. All updates to facility information must be routed through <a href="https://www.cdss.ca.gov/inforesources/child-care-licensing" target="_blank">Department of Social Services- Child Care Licensing Department</a> and will be reflected next year.<br />
                                  </p>
                                  <br />
                              </td>
          ...
          <table cellspacing="0" width="800px">
              ...
              <tr>
                  ...
                  <td colspan="3">
                      ...
                      <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Please remove space from Staff Member Completing This Form Email." OnServerValidate="CustomValidator1_ServerValidate"></asp:CustomValidator>
                      </td>
                  <td>Email:</td>
                  <td colspan="3">
            ...
            Ext:
                  ...
                  <td class="auto-style2" colspan="3">
                      <asp:TextBox ID="txtfcNumber" runat="server" MaxLength="3" TabIndex="25" Width="35px"></asp:TextBox><b>-</b>
                      <asp:TextBox ID="txtfcNumber_1" runat="server" MaxLength="3" TabIndex="26" Width="35px"></asp:TextBox><b>-</b>
