        ...
        */
        ...
        private void FillCity()
        {
            ...
            try
            {
                ...
                //{
                    ...
                    //sql = "SELECT DISTINCT S.PhysCity FROM Schools S INNER JOIN[Districts] D ON D.DistCode = S.DistCode INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and C.CoName = '" + county + "' and SchType = '" + type + "' and D.DistName = '" + district + "' ORDER BY S.PhysCity ASC";
                ...
                //else {
                    ...
                    sql = "SELECT DISTINCT S.PhysCity FROM Schools S INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and CoName = '" + county + "' and S.EditDate > '" + ActiveSchool + "' ORDER BY S.PhysCity ASC";
                //}
        ...
        private void FillSchool()
        {
            ...
            try
            {
                ...
                //{
                //sql = "SELECT distinct [SchName] FROM K_Assessment where SchoolYear = '" + schoolyear + "' and CoName = '" + county + "' and SchType = '" + type + "' and DistName = '" + district + "' ORDER BY [SchName] asc";
                //sql = "SELECT DISTINCT [SchName] FROM Schools S INNER JOIN[Districts] D ON D.DistCode = S.DistCode INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and C.CoName = '" + county + "' and SchType = '" + type + "' and D.DistName = '" + district + "' ORDER BY[SchName] ASC";

                //}
                //else {
                //sql = "SELECT distinct [SchName] FROM K_Assessment where SchoolYear = '" + schoolyear + "' and CoName = '" + county + "' and SchType = '" + type + "' ORDER BY [SchName] asc";
                //sql = "SELECT DISTINCT [SchName] FROM Schools S INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and CoName = '" + county + "' and S.EditDate > '" + ActiveSchool + "' ORDER BY[SchName] ASC";
                sql = "SELECT DISTINCT [SchName] FROM Schools S INNER JOIN[Counties] C ON C.CoCode = S.Cocode INNER JOIN Assessments A on A.schCode = S.SchCode WHERE Cohort = 'C' and CoName = '" + county + "' and S.Physcity = '" + city + "'  AND A.schoolYear = '" + SchoolYear + "' and S.EditDate > '" + ActiveSchool + "' ORDER BY[SchName] ASC";
                //}
        ...
        private void FillAddress()
        {
            ...
            try
            {
                ...
                //sql = "SELECT DISTINCT PhysStreet, PhysCity, SchCode FROM SCHOOLS S INNER JOIN [Districts] D ON D.DistCode = S.DistCode INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and C.CoName = '" + county + "' and[SchType] = '" + type + "'and D.DistName = '" + district + "' and SchName = '" + schoolname + "' ORDER BY PhysStreet";
                ...
                //sql = "SELECT distinct SchCode, PhysStreet, PhysCity FROM K_Assessment where SchoolYear = '" + schoolyear + "' and CoName ='" + county + "' and [SchType] = '" + type + "'and SchName = '" + schoolname + "' ORDER BY PhysCity, PhysStreet";
                    ...
                    // DISPLAYING MOST CURRENT ONE
                    //sql = "SELECT distinct PhysStreet, PhysCity, SchCode FROM SCHOOLS S INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and C.CoName ='" + county + "' and SchName = '" + schoolname + "' ORDER BY ENTERDATE DESC PhysStreet";
                    sql = "SELECT distinct PhysStreet, PhysCity, ENTERDATE FROM SCHOOLS S INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and C.CoName ='" + county + "' and SchName = '" + schoolname + "' and S.EditDate > '" + ActiveSchool + "' ORDER BY ENTERDATE DESC, PhysStreet";
        ...
        private void FillSchoolCode()
        {
            ...
            //string district = DistrictList.SelectedItem.Value.Replace("'", "''");
            string schoolname = SchoolNameList.SelectedItem.Value.Replace("'", "''");
            string selectedAddress = SchoolAddressList.SelectedItem.Value.Replace("'", "''");// AT on 11/14/2016
            ...
            try
            {
                ...
                //if ((type == "PUBLIC"))
                //{
                //sql = "SELECT DISTINCT SchCode FROM SCHOOLS S INNER JOIN [Districts] D ON D.DistCode = S.DistCode INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and C.CoName = '" + county + "' and[SchType] = '" + type + "'and D.DistName = '" + district + "' and SchName = '" + schoolname + "' ORDER BY SchCode";

                //}
                //else {
                //sql = "SELECT distinct SchCode FROM SCHOOLS S INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and C.CoName ='" + county + "' and SchName = '" + schoolname + "' and S.EditDate > '" + ActiveSchool + "' ORDER BY SchCode";
                sql = "SELECT distinct SchCode FROM SCHOOLS S INNER JOIN[Counties] C ON C.CoCode = S.Cocode WHERE Cohort = 'C' and C.CoName ='" + county + "' and SchName = '" + schoolname + "' and S.EditDate > '" + ActiveSchool + "' and S.PhysStreet = '" + selectedAddress + "' ORDER BY SchCode";
                //}
        ...
        */
        ...
        protected void txtSchoolCode_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if ((!string.IsNullOrEmpty(txtSchoolCode.Text)))
                {
                    ...
                    if (DoesSchoolExist() == true)
                    {
                        ...
                        {
                            //inactive schools
                            lblErrorMsg.Text = "This facility code is not active." + "<br />" + "Please see <a href=\"https://www.shotsforschool.org/reporting/childcare/faqs/\" target='_blank' alt='FAQs' title='FAQs'>FAQs</a> to find your facility code then contact <a href=\"mailto:SchoolAssessments@cdph.ca.gov\">SchoolAssessments@cdph.ca.gov</a> or your <a href=\"https://www.cdph.ca.gov/Programs/CID/DCDC/Pages/Immunization/Local-Health-Department.aspx\" target='_blank' alt='Local Health Department' title='LHD'>local health department</a> with your facility code and grade reporting to reactivate.";
                            MessagesRow.Visible = true;
                    ...
                    {
                        lblErrorMsg.Text = "This facility code does not exist." + "<br />" + "Please see <a href=\"https://www.shotsforschool.org/reporting/childcare/faqs/\" target='_blank' alt='FAQs' title='FAQs'>FAQs</a> to find your facility code then contact <a href=\"mailto:SchoolAssessments@cdph.ca.gov\">SchoolAssessments@cdph.ca.gov</a> or your <a href=\"https://www.cdph.ca.gov/Programs/CID/DCDC/Pages/Immunization/Local-Health-Department.aspx\" target='_blank' alt='Local Health Department' title='LHD'>local health department</a>.";
                        MessagesRow.Visible = true;
                        txtPassword.Enabled = false;
                    }
                }
            ...
            if (DoesSchoolExist() == true)
            {
                ...
                lblErrorMsg.Text = "This school code does not exist" + "<br />" + "Please retry or see <a href=\"http://cairweb.org/calkidshots/CCFAQs.pdf\" target='_blank' alt='FAQs' title='FAQs'>FAQs</a> to search.";
                MessagesRow.Visible = true;
                txtPassword.Enabled = false;
            }*/
        ...
        private void CheckPassword(ref bool pwdstatus)
        {
            ...
            //string sql = "SELECT TOP 1 id FROM Schools WHERE Cohort = 'C' and SchCode = '" + schoolCode + "'";
            string sql = "SELECT TOP 1 a.Assmntid FROM Schools S INNER JOIN Assessments A ON S.SchCode = a.SchCode where S.Cohort = 'C' and S.SchCode = '" + schoolCode + "' AND A.schoolYear = " + SchoolYear;
            ...
            try
            {
                ...
                if ((sdr.HasRows == true))
                {
                    ...
                    if (((String)Inpassword.ToUpper() == (String)defaultPassword.ToUpper()))
                    {
                        ...
                        Session["CC_Assessment_id"] = sdr[0];
        ...
        protected void ImgbtnLogin_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            ...
            string SchoolYear = System.Configuration.ConfigurationManager.AppSettings["SchoolYear"];
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["SAConnection"].ConnectionString);
            string sql = "SELECT A.isComplete FROM Schools S INNER JOIN Assessments A ON S.id = A.id WHERE S.Cohort = 'C' AND A.SchCode = '" + schoolCode + "' AND A.SchoolYear = '" + SchoolYear + "'";
            ...
            if ((Page.IsValid))
            {
                ...
                //bool openChildCare_20202021 = false;
                //if (openChildCare_20202021 == true) 
                //{ 
              ...
              /*} 
                    ...
                    MessagesRow.Visible = true;
                    lblErrorMsg.Text = "Pre-kindergarten reporting for the 2020-2021 school year will open soon";
                    txtPassword.Focus();
                }*/
            }
        }
        ...
        private bool DoesSchoolExist()
        {
            ...
            string sql = "SELECT COUNT(*) AS sch_num FROM Schools where SchCode ='" + schCode + "' AND cohort = 'C'";
        ...
        private bool IsSchoolActive()
        {
            ...
            string SchoolYear = System.Configuration.ConfigurationManager.AppSettings["SchoolYear"];
            string schoolcode = txtSchoolCode.Text.Replace("'", "''");
            string sql = "SELECT COUNT(*) AS sch_num FROM schools s WHERE s.SchCode = '" + schoolcode + "' AND s.cohort = 'C' AND EXISTS (SELECT * FROM assessments WHERE id = s.id AND SchoolYear = '" + SchoolYear + "')";
            SqlCommand cmd = new SqlCommand(sql);
            SqlDataReader reader = default(SqlDataReader);
