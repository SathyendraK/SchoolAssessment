        ...
        <div id="header-wrap">
            <div id="header">
                <div id="logo">
                    ...
                    <img src="Images/PRE_K_NOBKGRD.png" alt="Childcare Immunization Assessment" /></div><div id="duedateLogin">Reporting is due January 31, 2022</div>
                </div>
                <div id="topbnr">
                    ...
                    Worksheet <a href="http://eziz.org/SA/cdph8342.xls" target="_blank"><img src="Images/Icon_Excel.png" width="15" height="15" alt="Xls" title="Xls Worksheet" /></a>&nbsp;   
                    <a href="http://eziz.org/SA/cdph8342.pdf" target="_blank"> <img src="Images/Icon_pdf.png" width="15" height="15" alt="PDF" title="PDF Worksheet" /></a>
               </div>
        </div>
        <div id="content-wrap">
            <div id="content">
               ...
               <p> 
                    ...
                    <!--<span class="redbold">Licensed Family Home Care, Infant, and School Age Day Care Centers are not required to report. For more guidance, see <a href="https://eziz.org/assets/docs/shotsforschool/PreKAssessmentIZComm.pdf " target="_blank">here</a>.</span>-->
                    ...
                    <tr>
                        ...
                        <td width="350px" valign="center">
                            <table width="350px" cellspacing="2">
                                ...
                                <tr>
                                    <td class="indent2">
                                        <asp:TextBox ID="txtSchoolCode" runat="server" AutoPostBack="True" Width="175px" MaxLength="9" Enabled="true" OnTextChanged="txtSchoolCode_TextChanged"></asp:TextBox>
