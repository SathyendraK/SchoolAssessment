<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminChartKG.aspx.cs" Inherits="SchoolAssessment.Admin.AdminChartKG" %>
...
<body>
  ...
  <h1>Kindergarten Summary and Downloads</h1>
  ...
  <h2>Downloads</h2>
      <h4>TK / Kindergarten</h4>
       <p>Select Year:
          <asp:DropDownList ID="DownloadListYear" runat="server" autopostback="true" >
  ...
  <p>
    ...
    <asp:button id="btnSummaryReport" runat="server" text="Summary Report" causesvalidation="False" OnClick="btnSummaryReport_Click" />
      <asp:Button ID="btnConditionalOverdue" runat="server" Text=">=10% Conditional + Overdue" OnClick="btnConditionalOverdue_Click" />
  </p>
  <h4>1st Grade&nbsp;</h4>
  <p>Select Year:
      <asp:DropDownList ID="DownloadListYear_1st" runat="server" autopostback="true" >
          <asp:listitem value="20212022">2021-2022</asp:listitem> 
          <asp:listitem value="20202021">2020-2021</asp:listitem>
      </asp:DropDownList>
  </p>
  <p>
      <asp:Button ID="btnAllList_1st" runat="server" text="All List" causesvalidation="False" OnClick="btnAllList_1st_Click" />
      <asp:Button ID="ButtbtnNotReported_1st" runat="server" text="Delinquent List" causesvalidation="False" OnClick="ButtbtnNotReported_1st_Click" />
      <asp:Button ID="btnReported_1st" runat="server" text="Completed List" causesvalidation="False" OnClick="btnReported_1st_Click" />
      <asp:Button ID="btnSummaryReport_1st" runat="server" text="Summary Report" causesvalidation="False" OnClick="btnSummaryReport_1st_Click" />
      <asp:Button ID="btnConditionalOverdue_1st" runat="server" Text=">=10% Conditional + Overdue" OnClick="btnConditionalOverdue_1st_Click" />
