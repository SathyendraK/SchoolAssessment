...
{
    public partial class AdminChartCC : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sqlString = "SELECT t.SubmitDate, COUNT(t.SchCode) as NumberReported FROM (SELECT convert(date, t1.SubmitDate, 102) as SubmitDate, t1.SchCode FROM Assessments t1 INNER JOIN schools S on S.id = t1.id AND S.Cohort = 'C'";
            ...
            switch (sesAdminUserTYpe)
            {
                ...
                case "LHD":
                    ...
                    else if ((sesAdminCoCode == "61"))
                    {
                        ...
                        sql2 = " WHERE t1.isComplete = @isComplete and t1.SchoolYear = @SchoolYear and S.CoCode = @CoCode ";
                        //sql2 = " WHERE t1.isComplete = @isComplete and t1.SchoolYear = @SchoolYear and S.CoCode = 43 ";
                    }
                    break;
                case "FIELDREP":
                    if ((string.IsNullOrEmpty(cmbDateChartCounties.SelectedValue)))
            ...
            else if (sql2 != "")
            {
                ...
                cmd.Parameters.AddWithValue("@SchoolYear", SchoolYear);
                cmd.Parameters.AddWithValue("@isComplete", "Y");
                //cmd.Parameters.AddWithValue("@CoCode", cmbDateChartCounties.SelectedValue); //Session["AdminCoCode"].ToString();
            ...
            else if (sql3 != "")
            {
                ...
                cmd.Parameters.AddWithValue("@SchoolYear", SchoolYear);
                cmd.Parameters.AddWithValue("@isComplete", "Y");
                //cmd.Parameters.AddWithValue("@RegionCode", cmbCountyChart.SelectedItem.Value); //Session["AdminRegionCode"]
        ...
        private void SetTotalNumSchools()
        {
            ...
            // SQL FOR GETTING NUMBER OF REPORTED SCHOOLS BY DATE
            string sql = "SELECT COUNT(t1.SchCode) AS total FROM Assessments t1 INNER JOIN Schools S ON t1.id = S.id AND S.cohort = 'C'";
            ...
            switch (sesAdminUserTYpe)
            {
                ...
                case "LHD":
                    ...
                    {
                        sql += " WHERE t1.SchoolYear = '" + SchoolYear + "' and S.CoCode = '60' and S.PhysCity = 'LONG BEACH'";
                    }
                    else if ((sesAdminCoCode == "61"))
                    {
        ...
        protected void btnAllList_Click(object sender, EventArgs e)
        {
            ...
            string sqlString = "SELECT C.CoCode as CoCode, t1.SchCode as FacilityCode, C.CoName as CoName, ISNULL(s.SchType, '') as FacilityType, S.SchName as FacilityName, S.PhysStreet as PhysStreet, S.PhysCity as PhysCity, S.PhysZip as PhysZip, S.MailStreet as MailStreet, S.MailCity as MailCity, S.MailZip as MailZip, S.SchPhone as SchPhone, S.SchAdmin as SchAdmin, ISNULL(S.SchEmail, '') as SchEmail, ISNULL(S.SuperintendentName, '') as SuperintendentName, ISNULL(S.SuperintendentEmail, '') as SuperintendentEmail,  t1.ReportedPerson as StaffCompletingReport, t1.ReportedPhone as StaffCompletingReportPhone, t1.ReportedPhoneExt as StaffCompletingReportPhoneExt, t1.ReportedEmail as StaffCompletingReportEmail, ISNULL(S.ContactPerson, '') as DesignatedContact, ISNULL(S.ContactPhone, '') as DesignatedPhone, ISNULL(S.ContactPhoneExt, '') as DesignatedPhoneExt, S.ContactEmail as DesignatedEmail,  t1.TotNo as Enrollment, t1.AllImm as 'All Required',t1.NoImm as 'Conditional Without TME', ISNULL(t1.TempMedExemption, '0') as 'Temporary Medical Exemption',t1.MedExmp as 'Permanent Medical Exemption',t1.BeleExmp as 'Personal Beliefs Exemption', ISNULL(t1.IEPService, '0') as 'IEP Services', ISNULL(t1.EnrolledButNotAttending, '0') as 'Overdue',t1.DTP_DTAP_DT as DTP,t1.Polio as Polio, t1.MMRDose2 as MMR, t1.HIB as HIB,  t1.HepB as HepB,  t1.VZV as Varicella,  CASE WHEN isComplete = 'Y' THEN 'Reported' ELSE 'Not Reported' END as ReportingStatus, t1.StudentYesNo as 'CCThisYear',t1.Reason as 'Reason',s.EnterDate as AddSchoolDate, t1.SubmitDate as SubmitDate, t1.ReviseDate as ReviseDate, t1.LhdReviseDate as LhdReviseDate,  t1.SchoolYear as SchoolYear, t1.Memo as Memo  from Assessments t1 INNER JOIN Schools S on t1.SchCode = S.SchCode INNER JOIN Counties C ON C.CoCode = S.CoCode";
            ...
            string sqlString_admin = "SELECT C.CoCode as CoCode, t1.SchCode as FacilityCode, C.CoName as CoName, ISNULL(s.SchType, '') as FacilityType, S.SchName as FacilityName, S.PhysStreet as PhysStreet, S.PhysCity as PhysCity, S.PhysZip as PhysZip, S.MailStreet as MailStreet, S.MailCity as MailCity, S.MailZip as MailZip, S.SchPhone as SchPhone, S.SchAdmin as SchAdmin, ISNULL(S.SchEmail, '') as SchEmail, ISNULL(S.SuperintendentName, '') as SuperintendentName, ISNULL(S.SuperintendentEmail, '') as SuperintendentEmail,  t1.ReportedPerson as StaffCompletingReport, t1.ReportedPhone as StaffCompletingReportPhone, t1.ReportedPhoneExt as StaffCompletingReportPhoneExt, t1.ReportedEmail as StaffCompletingReportEmail, ISNULL(S.ContactPerson, '') as DesignatedContact, ISNULL(S.ContactPhone, '') as DesignatedPhone, ISNULL(S.ContactPhoneExt, '') as DesignatedPhoneExt, S.ContactEmail as DesignatedEmail,  t1.TotNo as Enrollment, t1.AllImm as 'All Required',t1.NoImm as 'Conditional Without TME', ISNULL(t1.TempMedExemption, '0') as 'Temporary Medical Exemption',t1.MedExmp as 'Permanent Medical Exemption',t1.BeleExmp as 'Personal Beliefs Exemption', ISNULL(t1.IEPService, '0') as 'IEP Services', ISNULL(t1.EnrolledButNotAttending, '0') as 'Overdue',t1.DTP_DTAP_DT as DTP,t1.Polio as Polio, t1.MMRDose2 as MMR, t1.HIB as HIB,  t1.HepB as HepB,  t1.VZV as Varicella,  CASE WHEN isComplete = 'Y' THEN 'Reported' ELSE 'Not Reported' END as ReportingStatus, t1.StudentYesNo as 'CCThisYear',t1.Reason as 'Reason',s.EnterDate as AddSchoolDate, t1.SubmitDate as SubmitDate, t1.ReviseDate as ReviseDate, t1.LhdReviseDate as LhdReviseDate,  t1.SchoolYear as SchoolYear, t1.Memo as Memo  from Assessments t1 INNER JOIN Schools S on t1.SchCode = S.SchCode INNER JOIN Counties C ON C.CoCode = S.CoCode";
            ...
            switch (sesAdminUserTYpe)
            {
                case "ADMIN":
                    ...
                    command = new SqlCommand(sqlString_admin + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear order by C.CoName Asc, S.SchType Asc, S.SchName Asc", con);
                    break;

                case "LHD":
                    if ((Session["AdminCoCode"].ToString() == "01"))
                    {
                        command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and C.CoCode = '01' and S.PhysCity <> 'BERKELEY' order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);
                    }
                    else if ((Session["AdminCoCode"].ToString() == "19"))
                    {
                        command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and C.CoCode = '19' and S.PhysCity <> 'LONG BEACH' and S.PhysCity <> 'PASADENA' order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);
                    }
                    ...
                    {
                        command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and C.CoCode = '60' and S.PhysCity = 'LONG BEACH' order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);
                    }
                    else if ((Session["AdminCoCode"].ToString() == "61"))
                    {
                        command = new SqlCommand(sqlString + " where t1.SchoolYear = @SchoolYear AND S.cohort = 'C' and C.CoCode = '19' and S.PhysCity = 'PASADENA' order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);
                    }
                    else {
                        command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and C.CoCode = @CoCode order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);
                        command.Parameters.AddWithValue("@CoCode", Session["AdminCoCode"].ToString()); // added toString() on 10/06/2016
                    }
                    break;
                case "FIELDREP":
                    command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and C.RegionCode = @RegionCode AND S.cohort = 'C' order by C.CoName Asc, S.SchType Asc, S.SchName Asc", con);
                    command.Parameters.AddWithValue("@RegionCode", Session["AdminRegionCode"].ToString());
                    break;
            }
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=CCAll.xls");
            ...
            for (row = 0; row <= dt.Rows.Count - 1; row++)
            {
                ...
                for (column = 0; column <= dt.Columns.Count - 1; column++)
                {
                    ...
                    {
                        case "FacilityCode":
                            Response.Write("<td style=\"mso-number-format:000000000\\\">" + dt.Rows[row][column].ToString() + "</td>");
                            break;
                        case "CoCode":
        ...
        protected void btnNotReported_Click(object sender, EventArgs e)
        {
            ...
            {
                case "ADMIN":
                    command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and t1.isComplete = @isComplete order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);

                    break;
                case "LHD":
                    if ((Session["AdminCoCode"].ToString() == "01"))
                    {
                        command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and S.CoCode = '01' and S.PhysCity <> 'BERKELEY' and t1.isComplete = @isComplete order by C.CoName Asc, S.SchType Asc, S.SchName Asc", con);
                    }
                    else if ((Session["AdminCoCode"].ToString() == "19"))
                    {
                        command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and S.CoCode = '19' and S.PhysCity <> 'LONG BEACH' and S.PhysCity <> 'PASADENA' and t1.isComplete = @isComplete order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);
                    }
                    else if ((Session["AdminCoCode"].ToString() == "59"))
                    {
                        command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and S.CoCode = '01' and S.PhysCity = 'BERKELEY' and t1.isComplete = @isComplete order by C.CoName Asc, S.SchType Asc, S.SchName Asc", con);
                    ...
                    {
                        command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and S.CoCode = '19' and S.PhysCity = 'LONG BEACH' and t1.isComplete = @isComplete order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);
                    }
                    else if ((Session["AdminCoCode"].ToString() == "61"))
                    {
                        command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and S.CoCode = '19' and S.PhysCity = 'PASADENA' and t1.isComplete = @isComplete order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);
                    }
                    else {
                        command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and S.CoCode = @CoCode and t1.isComplete = @isComplete order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);
                        command.Parameters.AddWithValue("@CoCode", Session["AdminCoCode"]);
                    }
                    break;
                case "FIELDREP":
                    command = new SqlCommand(sqlString + " where S.cohort = 'C' AND t1.SchoolYear = @SchoolYear and C.RegionCode = @RegionCode and t1.isComplete = @isComplete order by C.CoName Asc, S.SchType Asc,  S.SchName Asc", con);
            ...
            Response.Clear();
            Response.ContentType = "text/csv";
            Response.AddHeader("Content-Disposition", "attachment; filename=CCNotReported.xls");
        ...
        protected void btnReported_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.ContentType = "text/csv";
            Response.AddHeader("Content-Disposition", "attachment; filename=CCReported.xls");
        ...
        protected void btnSummaryReport_Click(object sender, EventArgs e)
        {
            ...
            //string sqlString = "select t1.SchCode as [Facility Number], isnull(S.SchName, 'ALL SCHOOLS') as [School],S.SchType as [Public/Private/Head Start],S.PhysCity as [City],t1.Enrollment, t2.submitDate as [SubmitDate], t1.AllImm,case when (t1.Enrollment > 0) then round(t1.AllImm*100 /cast(t1.Enrollment as float), 2) else 0 end as [AllImm%], t1.Conditional,case when (t1.Enrollment > 0) then round(t1.Conditional*100 /cast(t1.Enrollment as float), 2) else 0 end as [Conditional%],ISNULL(t1.PME, 0) AS [PME%], case when (t1.Enrollment > 0) then round(ISNULL(t1.PME, 0)*100 /cast(t1.Enrollment as float), 2) else 0 end as [PME%], ISNULL(t1.PBE, 0) as [PBE],case when (t1.Enrollment > 0) then round(ISNULL(t1.PBE, 0)*100 /cast(t1.Enrollment as float), 2) else 0 end as [PBE%] from (select a.SchCode, sum(a.TotNo) as Enrollment, sum(a.AllImm) as AllImm,sum(a.TotNo-a.AllImm) as Conditional,sum(a.MedExmp) as PME,sum(a.BeleExmp) as PBE  from Assessments a ";
            string sqlString = "select t1.SchCode as [Facility Number], isnull(S.SchName, 'ALL SCHOOLS') as [Facility],S.SchType as [Public/Private/Head Start],S.PhysCity as [City],t1.Enrollment, t2.submitDate as [SubmitDate], t1.AllImm,case when (t1.Enrollment > 0) then round(t1.AllImm*100 /cast(t1.Enrollment as float), 2) else 0 end as [AllImm%], ISNULL(t1.PBE, 0) as [PBE],case when (t1.Enrollment > 0) then round(ISNULL(t1.PBE, 0)*100 /cast(t1.Enrollment as float), 2) else 0 end as [PBE%], ISNULL(t1.PME, 0) AS [PME], case when (t1.Enrollment > 0) then round(ISNULL(t1.PME, 0)*100 /cast(t1.Enrollment as float), 2) else 0 end as [PME%],  t1.OtherIEP as [IEP], case when (t1.Enrollment > 0) then round(t1.OtherIEP*100 /cast(t1.Enrollment as float), 2) else 0 end as [IEP%], ISNULL(t1.conditional, 0) as [Conditional], case when (t1.Enrollment > 0) then round(t1.Conditional*100 /cast(t1.Enrollment as float), 2) else 0 end as [Conditional%], ISNULL(t1.TME, 0) as [TME], case when (t1.Enrollment > 0) then round(ISNULL(t1.TME, 0)*100 /cast(t1.Enrollment as float), 2) else 0 end as [TME%] , ISNULL(t1.Overdue, 0) as [Overdue], case when (t1.Enrollment > 0) then round(ISNULL(t1.Overdue, 0)*100 /cast(t1.Enrollment as float), 2) else 0 end as [Overdue%]  from (select a.SchCode, sum(a.TotNo) as Enrollment, sum(a.AllImm) as AllImm,sum(a.NoImm) as Conditional,sum(a.MedExmp) as PME, sum(a.BeleExmp) as PBE, sum(a.TempMedExemption) as TME, sum(a.EnrolledButNotAttending) as Overdue, sum(a.IEPService) as OtherIEP  from Assessments a ";

            // Added sqlString_admin by A.T. on 09/24/2014 to capture PBE subfields in the export. 
            string sqlString_admin = "select t1.SchCode as [Facility Number], isnull(S.SchName, 'ALL SCHOOLS') as [Facility],S.SchType as [Public/Private/Head Start],S.PhysCity as [City],t1.Enrollment, t2.submitDate as [SubmitDate], t1.AllImm,case when (t1.Enrollment > 0) then round(t1.AllImm*100 /cast(t1.Enrollment as float), 2) else 0 end as [AllImm%], ISNULL(t1.PBE, 0) as [PBE],case when (t1.Enrollment > 0) then round(ISNULL(t1.PBE, 0)*100 /cast(t1.Enrollment as float), 2) else 0 end as [PBE%], ISNULL(t1.PME, 0) AS [PME], case when (t1.Enrollment > 0) then round(ISNULL(t1.PME, 0)*100 /cast(t1.Enrollment as float), 2) else 0 end as [PME%],  t1.OtherIEP as [IEP], case when (t1.Enrollment > 0) then round(t1.OtherIEP*100 /cast(t1.Enrollment as float), 2) else 0 end as [IEP%], ISNULL(t1.conditional, 0) as [Conditional], case when (t1.Enrollment > 0) then round(t1.Conditional*100 /cast(t1.Enrollment as float), 2) else 0 end as [Conditional%], ISNULL(t1.TME, 0) as [TME], case when (t1.Enrollment > 0) then round(ISNULL(t1.TME, 0)*100 /cast(t1.Enrollment as float), 2) else 0 end as [TME%] , ISNULL(t1.Overdue, 0) as [Overdue], case when (t1.Enrollment > 0) then round(ISNULL(t1.Overdue, 0)*100 /cast(t1.Enrollment as float), 2) else 0 end as [Overdue%]  from (select a.SchCode, sum(a.TotNo) as Enrollment, sum(a.AllImm) as AllImm,sum(a.NoImm) as Conditional,sum(a.MedExmp) as PME, sum(a.BeleExmp) as PBE, sum(a.TempMedExemption) as TME, sum(a.EnrolledButNotAttending) as Overdue, sum(a.IEPService) as OtherIEP  from Assessments a ";

            string orderbyString = "group by a.SchCode with rollup) t1 left join Assessments t2 on t1.SchCode = t2.SchCode INNER JOIN Schools S on t2.schcode = S.SchCode WHERE t2.SchoolYear = @SchoolYear AND S.Cohort = 'C' order by S.PhysCity, t1.SchCode asc";

            switch (sesAdminUserTYpe)
            {
                case "ADMIN":
                    command = new SqlCommand(sqlString_admin + " WHERE a.isComplete = @isComplete and a.SchoolYear = @SchoolYear " + orderbyString, con);

                    break;
                case "LHD":
                    if ((Session["AdminCoCode"].ToString() == "01"))
                    {
                        command = new SqlCommand(sqlString + "INNER JOIN Schools S on S.schcode = a.schcode  WHERE a.isComplete = @isComplete and a.SchoolYear = @SchoolYear and S.CoCode = '01' and S.PhysCity <> 'BERKELEY' " + orderbyString, con);
                    }
                    else if ((Session["AdminCoCode"].ToString() == "19"))
                    {
                        command = new SqlCommand(sqlString + "INNER JOIN Schools S on S.schcode = a.schcode WHERE a.isComplete = @isComplete and a.SchoolYear = @SchoolYear and S.CoCode = '19' and S.PhysCity <> 'LONG BEACH' and S.PhysCity <> 'PASADENA' " + orderbyString, con);
                    }
                    else if ((Session["AdminCoCode"].ToString() == "59"))
                    {
                        command = new SqlCommand(sqlString + "INNER JOIN Schools S on S.schcode = a.schcode WHERE a.isComplete = @isComplete and a.SchoolYear = @SchoolYear and S.CoCode = '01' and S.PhysCity = 'BERKELEY' " + orderbyString, con);
                    ...
                    {
                        command = new SqlCommand(sqlString + "INNER JOIN Schools S on S.schcode = a.schcode  WHERE a.isComplete = @isComplete and a.SchoolYear = @SchoolYear and S.CoCode = '19' and S.PhysCity = 'LONG BEACH' " + orderbyString, con);
                    }
                    else if ((Session["AdminCoCode"].ToString() == "61"))
                    {
                        command = new SqlCommand(sqlString + "INNER JOIN Schools S on S.schcode = a.schcode  WHERE a.isComplete = @isComplete and a.SchoolYear = @SchoolYear and S.CoCode = '19' and S.PhysCity = 'PASADENA' " + orderbyString, con);
                    }
                    else {
                        command = new SqlCommand(sqlString + "INNER JOIN Schools S on S.schcode = a.schcode WHERE a.isComplete = @isComplete and a.SchoolYear = @SchoolYear and S.CoCode = @CoCode " + orderbyString, con);
                        command.Parameters.AddWithValue("@CoCode", Session["AdminCoCode"]);
                    }
                    break;
                case "FIELDREP":
                    command = new SqlCommand(sqlString + " INNER JOIN Schools S on S.schcode = a.schcode INNER JOIN Counties C on C.Cocode = S.CoCode  WHERE a.isComplete = @isComplete and a.SchoolYear = @SchoolYear and C.RegionCode = @RegionCode " + orderbyString, con);
                    command.Parameters.AddWithValue("@RegionCode", Session["AdminRegionCode"]);
                    break;
            }
            ...
            Response.Clear();
            Response.ContentType = "text/csv";
            Response.AddHeader("Content-Disposition", "attachment; filename=CCSummary.xls");
        ...
        protected void btnConditionalOverdue_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.ContentType = "text/csv";
            Response.AddHeader("Content-Disposition", "attachment; filename=CCOverdueConditionalRPT.xls");
