    ...
    <tr>
      ...
      <td>
        <asp:textbox id="txtSchEmail" runat="server" tabindex="14"></asp:textbox>
          <asp:CustomValidator ID="CustomValidator3" runat="server" Display="Dynamic" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Administrator Email - Invalid character<br>" OnServerValidate="CustomValidator3_ServerValidate"></asp:CustomValidator>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <asp:textbox id="txtSuperintendentEmail" runat="server" tabindex="16"></asp:textbox>
          <asp:CustomValidator ID="CustomValidator4" runat="server" Display="Dynamic" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Superintendent Email - Invalid character<br>" OnServerValidate="CustomValidator4_ServerValidate"></asp:CustomValidator>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        ...
        <asp:requiredfieldvalidator id="Requiredfieldvalidator13" runat="server" controltovalidate="txtContactEmail" text="*" cssclass="RequiredFieldValidator" />
          <asp:CustomValidator ID="CustomValidator2" runat="server" Display="Dynamic" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Designated Contact Email - Invalid character<br>" OnServerValidate="CustomValidator2_ServerValidate"></asp:CustomValidator>  
      </td>
      <td>
      </td>
      <td>
