<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAddSchoolKG.aspx.cs" Inherits="SchoolAssessment.Admin.AdminAddSchoolKG" %>
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        ...
        <asp:regularexpressionvalidator id="RegularExpressionValidator1" controltovalidate="txtSchoolCode" validationexpression="\d{7}" text="&bull;" errormessage="School Code - Invalid format (must be 7 digits with leading zeroes)." runat="server" cssclass="RequiredFieldValidator" />
      </td>
    </tr>
    <tr>
      <td>
