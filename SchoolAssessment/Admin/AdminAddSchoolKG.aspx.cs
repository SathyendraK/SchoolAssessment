...
{
    public partial class AdminAddSchoolKG : System.Web.UI.Page
    {
            ...
            if ((Page.IsValid))
            {
                ...
                try
                {
                    ...
                    if ((ret > 0 && ret2 > 0))
                    {
                        ...
                        lblMsg.Text = "<p><span class=\"greenbold\">New school added: <a href=\"AdminEditSchoolKG.aspx?id=" + ret2 + "\">Edit/view new school</a></span></p>";
                        lblMsg.Visible = true;
                    }
                }
                catch (Exception ex)
