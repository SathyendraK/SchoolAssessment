<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminEditSchool7th.aspx.cs" Inherits="SchoolAssessment.Admin.AdminEditSchool7th" %>
  ...
  <table runat="server" id="Table1">
    ...
    <tr>
      ...
      <td class="auto-style1">
        ...
        <!-- Changed from requiredfieldvalidator to CustomValidator by AT on 09/17/2015 -->
        <asp:CustomValidator ID="districtCodeValidator" runat="server" OnServerValidate="districtCodeValide" Display="Dynamic" Text="*" cssclass="RequiredFieldValidato r"></asp:CustomValidator>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td colspan="3">
        <asp:dropdownlist id="drpReason" runat="server" tabindex="25">
          ...
          <asp:listitem value="NO 7th GRADER THIS YEAR">NO 7th Grader THIS YEAR</asp:listitem>
          <asp:listitem value="NO 7th GRADER EVER">NO 7th Grader EVER</asp:listitem>
