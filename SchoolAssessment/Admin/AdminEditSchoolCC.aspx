<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminEditSchoolCC.aspx.cs" Inherits="SchoolAssessment.Admin.AdminEditSchoolCC" %>
...
<body>
  ...
  <table runat="server" id="Table1">
   ...
   <tr>
        ...
        <td> District Code</td>
        <td>
            <asp:TextBox id="txtDistrictCode" runat="server" columns="10" maxlength="5"></asp:TextBox>
            </td>
   </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        <asp:regularexpressionvalidator id="RegularExpressionValidator1" controltovalidate="txtSchoolCode" validationexpression="\d{9}" text="&bull;" errormessage="School Code - Invalid format (must be 9 digits with leading zeroes)<br>" runat="server" cssclass="RequiredFieldValidator" />
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td colspan="3">
        ...
        <asp:requiredfieldvalidator id="reqReason" runat="server" controltovalidate="drpReason" text="Please select a reason"  ErrorMessage="Please select a reason for not having any Childcare students enrolled this year" cssclass="RequiredFieldValidator" Display="Dynamic" />
      </td>
    </tr>
    <tr>
      <td height="24">
    ...
    <tr>
      ...
      <td>
        ...
        <asp:textbox id="txtFormPhoneExt" runat="server" columns="7" maxlength="7" tabindex="29" Height="22px"></asp:textbox>
      </td>
      <td colspan="2">
