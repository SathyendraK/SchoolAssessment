<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminReportCC.aspx.cs" Inherits="SchoolAssessment.Admin.AdminReportCC" %>
      ...
      <td>        
        <table  cellpadding="2" cellspacing="5">
          ...
          <td>
            ...
            <td>
              <asp:textbox runat="server" id="txtSchoolCode" columns="20" maxlength="9"></asp:textbox>
              <asp:RegularExpressionValidator ID="RegularExpressionValidator1" controltovalidate="txtSchoolCode" validationexpression="\d{9}" text="&bull;"  runat="server" ErrorMessage="Facility Number - Invalid format (must be 9 digits with leading zeroes)<br>"></asp:RegularExpressionValidator>
            </td>
            <td>
              Facility Name:
            </td>
         ...
         <tr>
             <td>County:</td>
             <td><asp:textbox runat="server" id="txtCounty"></asp:textbox></td>
             <td>District:</td>
             <td colspan="3">
  ...
  <asp:button id="btnNotReported" visible="false" runat="server" text="All Not Reported Schools" /></p>-->
      ...
      <asp:GridView ID="grdVSchools" runat="server"  allowpaging="True" PageSize = "15"  CellPadding="4" ForeColor="#333333" GridLines="None"  autogeneratecolumns="False"   AllowSorting="True" OnRowCommand="grdVSchools_RowCommand" OnSelectedIndexChanged="grdVSchools_SelectedIndexChanged" OnPageIndexChanging="grdVSchools_PageIndexChanging" OnSorting="grdVSchools_Sorting" OnRowDataBound="grdVSchools_RowDataBound"  >
          ...
          <Columns>
              ...
              <asp:BoundField FooterText="District" />
