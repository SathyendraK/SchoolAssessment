      ...
      <div id="content">
        ...
        <table width="800">
            ...
            <tr>
                ...
                <asp:CustomValidator ID="CustomValidator8" OnServerValidate="NoImmMinimum" Display="Dynamic" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="The sum of missing doses by vaccine must be greater than or equal to number of conditioonal entrant" runat="server" />
        ...
        <p>
          ...
          <asp:button id="btnNext" runat="server" text="Submit Report" tabindex="25" OnClick="btnNext_Click"></asp:button>
