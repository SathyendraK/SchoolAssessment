  ...
  <div id="container">
    <div id="header-wrap">
      <div id="header"> <div id="logo">
        ...
        <div id="logout">
            <form id="Form1" method="post" runat="server" autocomplete="off"><asp:Button ID="hdrLogout" runat="server" Text="Logout" causesvalidation="False" OnClick="hdrLogout_Click"/>
        </div>
      </div>
    </div>
    <div id="content-wrap">
      <div id="content">
        ...
        <table width="800">
            ...
            <tr>
                ...
                <asp:CustomValidator ID="CustomValidator8" OnServerValidate="NoImmMinimum" Display="Dynamic" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="The sum of missing doses by vaccine must be greater than or equal to number of conditional entrant" runat="server" />
                <asp:CustomValidator ID="CustomValidator26" OnServerValidate="NoImmZeroesValidate" Display="Dynamic" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="Please enter missing doses by vaccine since you have conditional Entrants." runat="server" />
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CompareValidator ID="CustomValidator2" ControlToValidate="txtPolio" Type="Integer" ControlToCompare="txtNoimm" Operator="LessThanEqual" Display="Dynamic" CssClass="RequiredFieldValidator" Text="&bull;" ErrorMessage="The number of missing doses by vaccines entered should be less than or equal to the number of conditional entrant" runat="server" />
                            </td>
