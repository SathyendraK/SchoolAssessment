              ...
              <table cellspacing="0" width="100%">
                <tr>
                  <td>
                    <table width="100%">
                       <tr>
                            <td colspan="4"><b>School Information</b></td>
                        </tr>
                      <tr>
                        ...
                        <tr>
                        <td class="auto-style4">School code:</td>
                      ...
                      <tr>
                        ...
                        <td class="auto-style4">Public School District:</td>
                        <td><asp:label id="lbldistrict" runat="server"></asp:label></td>
                        <td colspan="2"></td>
                      </tr>
                      <tr>
                        <td class="auto-style4">County:</td>
                      ...
                      <tr>
                          <td class="auto-style4">Administrator: </td>
                          <td><asp:label id="lblSchAdmin" runat="server"></asp:label></td>
                          <td colspan="2"></td>
                      </tr>
                      <tr>
                          <td class="auto-style4">School Email: </td>
                          <td><asp:label id="lblSchEmail" runat="server"></asp:label></td>
                          <td colspan="2"></td>
                      </tr>      
                      <tr>
                        <td class="auto-style4">Physical Address:</td>
                        ...
                        <tr>
                            <td colspan="4"><b>School Staff Member Completing This Form</b></td>
                        </tr>
                        <tr>
                            <td class="indent" style="width: 207px">Name:</td>
                            <td>
                                <asp:Label ID="lblstaffPrsn" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="indent" style="width: 207px">Email:</td>
                            <td>
                                <asp:Label ID="LblStaffEmail" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="indent" style="width: 207px">Phone Number:</td>
                            <td>
                                <asp:Label ID="lbsStaffPhone" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="indent" style="width: 207px">Phone Number Ext:</td>
                            <td>
                                <asp:Label ID="lblStaffPhoneExt" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="indent" style="width: 207px">Report Submitted Date:</td>
                            <td>
                        ...
                        <tr><td colspan="4"><br /></td></tr>
                        <tr>
                            <td colspan="4"><b>Designated School Contact</b></td>
                        </tr>
                        <tr>
                            <td class="indent" style="width: 207px">Name:</td>
                            <td>
