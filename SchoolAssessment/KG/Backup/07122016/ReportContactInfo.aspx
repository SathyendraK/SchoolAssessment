...
<body>
  <div id="container">
    ...
    <div id="content-wrap">
      <div id="content">
        <center><img src="Images/Step_02.png" alt="School information:" /></center>
          <form id="Form1" method="post" runat="server" autocomplete="off">
        <br />
        <h2><img src="Images/hdr_contact.png" alt="Please confirm School information:" /></h2>
        <asp:label id="ErrorMsg" runat="server"></asp:label>
        <asp:validationsummary id="valSum" displaymode="BulletList" headertext="Please correct the follwoing errors marked with bullets:" runat="server" cssclass="ValidationSummary" />
        <table width="800">
          <tr>
            <td>
              ...
              <table cellspacing="0" width="100%">
                <tr>
                  <td>Information updated on this page is for reporting purposes only. <br /><br />
                  </td>
...
<table cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <span class="small">(<asp:CheckBox ID="chkcontact" runat="server" autopostback="True" tabindex="19" OnCheckedChanged="chkcontact_CheckedChanged" /></asp:checkbox>Check if same person)</span>
        </td>
    </tr>
    <tr>
	...
	<tr>
		...
		<td class="auto-style2" >
                          <asp:textbox id="txtStaffPhNo" maxlength="12" runat="server" width="120px" tabindex="17" ></asp:textbox>
		...
		<td class="auto-style2">Ext:</td>
        <td class="auto-style6" >
                          <asp:textbox id="txtStaffPhNoExt" maxlength="4" columns="4" runat="server" tabindex="18" width="53px"></asp:textbox>
        </td>
		<td class="auto-style4">Phone:</td>
		<td class="auto-style2">
                          <asp:textbox id="txtfcNumber"  runat="server" maxlength="12" tabindex="23" width="120px"></asp:textbox>
		...
		<td class="auto-style2" >Ext:</td>
        <td class="auto-style6">
                          <asp:textbox id="txtfcNumberExt" runat="server" maxlength="4" columns="4" tabindex="24" width="53px"></asp:textbox>
         </td>
