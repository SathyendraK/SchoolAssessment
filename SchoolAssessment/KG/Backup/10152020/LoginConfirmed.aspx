  ...
  <div id="container">
    <div id="header-wrap">
      <div id="header"> <div id="logo">
          ...
          <a href="https://www.shotsforschool.org/reporting/" target="_blank"><img src="Images/kheader.png" alt="Kindergarten Immunization Assessment" /></a></div>
          ...
          <div id="topbnr">
               ...
               <a href="https://www.shotsforschool.org/reporting/kindergarten/faqs/" target="_blank" alt="FAQs" title="FAQs"> FAQs <img src="Images/Icon_instr.png" width="15" /> </a> | 
                Worksheet <a href="http://cairweb.org/calkidshots/PM236a.xls" target="_blank"><img src="Images/Icon_Excel.png" width="15" height="15" alt="Xls" title="Xls Worksheet" /></a>&nbsp;   
                    <a href="http://cairweb.org/calkidshots/PM236a.pdf" target="_blank"> <img src="Images/Icon_pdf.png" width="15" height="15" alt="PDF" title="PDF Worksheet" /></a>|
    ...
    <div id="content-wrap">
      <div id="content">
        ...
        <table id="Table1" cellpadding="4">
          <tr><td colspan="3">Disclaimer: Information updated on this page is for reporting purposes only. All updates to school information must be routed through the <a href="http://www.cde.ca.gov/re/sd/corrections.asp" target="_blank">California School Directory- Submitting Corrections</a> and will be reflected next year. <br />
              <br />
              </td></tr>
            <tr>
          ...
          <tr>
            ...
            <td colspan="2">
                 <!--Commented out on 06/05/2020 
                   ...
                   -->
              <asp:DropDownList ID="drpvirtual" runat="server" Width="120px">
                <asp:ListItem Value="1">Exclusively Virtual</asp:ListItem>
                <asp:ListItem Value="2">Primarily Virtual</asp:ListItem>
                <asp:ListItem Value="3">Primarily Classroom</asp:ListItem>
                <asp:ListItem Value="4">Not Virtual</asp:ListItem>
                <asp:ListItem Value="5">Partial Virtual</asp:ListItem>
              </asp:DropDownList>
            </td>
          </tr>
        </table>
