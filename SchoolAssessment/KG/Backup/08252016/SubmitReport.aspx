    ...
    <div id="content-wrap">
      <div id="content" >
        ...
        <p>
          ...
          <asp:button id="btnNext" runat="server" text="Submit Report" tabindex="27" OnClick="btnNext_Click" OnClientClick = "Confirm()"></asp:button>
            ...
            <asp:ImageButton ID="ImgBtnSubmit" runat="server"  Enabled="true" ImageUrl="images/btn_submit.png" tabindex="27" OnClick="ImgBtnSubmit_Click" OnClientClick = "Confirm()" />
