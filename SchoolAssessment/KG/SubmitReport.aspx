...
<body>
  <div id="container">
    ...
    <div id="content-wrap">
      <div id="content" >
        <br />
        <center><img src="Images/KFst_step3.png" alt="School information:" /></center>
        <h2><img src="Images/submit-hdr-tk-kinder.jpg" alt="Please confirm School information:" /></h2>
...
" runat="server" display="Dynamic" />
        ...
        <p>
            ...
            <asp:ImageButton ID="ImgBtnSubmit" runat="server"  Enabled="true" ImageUrl="images/btn4_next.png" tabindex="27" OnClick="ImgBtnSubmit_Click" /><!--btn7_submitreport.png--><!--OnClientClick = "Confirm()" -->
        </p> 
        <p>&nbsp;</p>
        <hr />
            <br />
