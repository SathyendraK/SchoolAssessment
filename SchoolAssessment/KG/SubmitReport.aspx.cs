...
/*
 *  07/28/2021 -- Adding Step 4 to get 1st grader report in Save()
 *  08/5/2021 -- Added Status
 * */
...
namespace SchoolAssessment.KG
{
    ...
    */
                        ...
                        // Adding Step 4 -- to report 1st graders 07/28/2021
                        //Response.Redirect("ViewAndPrint.aspx", true);
                        Response.Redirect("SubmitFirstGradeReport.aspx", true);
                    }
                    else {
        ...
        private void logaudittrail(string fieldname, string fromval, string toval)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@ScreenName", "KSubmitReport");
