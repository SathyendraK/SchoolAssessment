    ...
    public partial class EditDetails : System.Web.UI.Page
    {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        */
                        ...
                        txtSchoolCode.Text = (String)reader["SchCode"].ToString(); 
                        txtSchoolName.Text = (String)reader["SchName"].ToString(); 
                        hdnschname.Value = (String)reader["SchName"].ToString(); 
                        txtSchoolType.Text = (String)reader["SchType"].ToString(); 
                        txtCounty.Text = (String)reader["CoName"].ToString(); 
                        txtDistrict.Text = (String)reader["DistName"].ToString(); 
                        txtPhyAddress.Text = (String)reader["PhysStreet"].ToString(); 
                        hdnphystreet.Value = (String)reader["PhysStreet"].ToString(); 
                        txtPhyCity.Text = (String)reader["PhysCity"].ToString(); 
                        hdnphycity.Value = (String)reader["PhysCity"].ToString(); 
                        txtPhyZip.Text = (String)reader["PhysZip"].ToString(); 
                        hdnphyzip.Value = (String)reader["PhysZip"].ToString(); 
                        txtMailAddress.Text = (String)reader["MailStreet"].ToString(); 
                        hdnmailstreet.Value = (String)reader["MailStreet"].ToString(); 
                        txtMailCity.Text = (String)reader["MailCity"].ToString(); 
                        hdnmailcity.Value = (String)reader["MailCity"].ToString(); 
                        txtMailZip.Text = (String)reader["MailZip"].ToString();
                        hdnmailzip.Value = (String)reader["MailZip"].ToString(); 
                        ...
                        hdnSchAdmin.Value = (String)reader["SchAdmin"].ToString();
            ...
            if (((Session["K_Assessment_id"] == null)))
            {
                ...
                try
                {
                    ...
                    */
                    ...
                    sql = "UPDATE Schools SET EditDate = GETDATE(), schEmail = @SchEmail, SchAdmin = @SchAdmin where id = '" + id + "'";
                    SqlCommand cmd = new SqlCommand(sql, con);
                    ...
                    */
                    ...
                    if ((hdnSchEmail.Value != TextSchEmail.Text))
                    {
                        logaudittrail("SchEmail", hdnSchEmail.Value, TextSchEmail.Text);
                    }
                    if ((hdnSchAdmin.Value != TextSchAdmin.Text))
                    {
                        logaudittrail("SchAdmin", hdnSchAdmin.Value, TextSchAdmin.Text);
                    }
                }
                catch (Exception ex)
                {
        ...
        private void logaudittrail(string fieldname, string fromval, string toval)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@SchoolCode", hdnSchCode.Value);
