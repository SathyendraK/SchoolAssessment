...
<body>
  <div id="container">
    ...
    <div id="content-wrap">
      <div id="content" >
        <center><img src="Images/KFst_step2.png" alt="School information:" /></center>
        ...
        <asp:validationsummary id="valSum" displaymode="BulletList" headertext="Please correct the following errors:" runat="server" cssclass="ValidationSummary" />
          ...
          <table cellspacing="0" width="800px">
              ...
              <tr>
               ...
               <tr>
                   <td class="auto-style4">
                      <b>Kindergarten Status:</b>
                  </td>
                  <td>
                      <asp:Label ID="lblStatus" runat="server"></asp:Label></td>
               </tr>
              <tr><td class="auto-style4"><b>1st Grade Status:</b></td>
                  <td><asp:Label ID="lblStatus_1st" runat="server"></asp:Label></td>
              </tr>
              <tr>
                  <td colspan="8"> <br /></td>
              </tr>
              ...
              <tr>
                  ...
                  <td colspan="6">
                      <asp:TextBox ID="txtmail" runat="server" Width="500px" TabIndex="15" MaxLength="50"></asp:TextBox>
            ...
            Ext:
              ...
              <tr>
                  <td colspan="8" class="auto-style2"><strong>Designated School Contact</strong>
